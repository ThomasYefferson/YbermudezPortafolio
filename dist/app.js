...
/*VARIABLES  EDUCATION SECTION*/

const educationSection = document.querySelector('#educationSection');
const articles1 = document.querySelectorAll('#educationSection article');
...
const firstLink1 = document.querySelector('#link2');

educationLinks.forEach((link) => {
  link.addEventListener('click', () => {
    firstLink1.classList.remove(
      'border-sky-500',
      'bg-white',
      'dark:bg-slate-700'
    );
